...
urlpatterns = [
    ...
    path('viaticos/<int:pk>/legalizacion/devolver/', views.fin_viaticos_legalizacion_devolver,
         name='fin_viaticos_legalizacion_devolver'),
    path('viaticos/<int:pk>/finalizar/', views.fin_viaticos_finalizar, name='fin_viaticos_finalizar'),
