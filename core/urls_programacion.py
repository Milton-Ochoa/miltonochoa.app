"""URLconf del subdominio **programacion** (`programacion.miltonochoa.app`).

Monta el área `programacion` en la **raíz** del subdominio (antes era el prefijo
`/programacion/`). Incluye también el login único (`usuarios`) y la PWA para que:
...
urlpatterns = [
    ...
    # Área programacion montada en la raíz del subdominio.
