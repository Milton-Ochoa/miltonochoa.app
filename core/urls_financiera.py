"""URLconf del subdominio **financiera** (`financiera.miltonochoa.app`).

Espejo de `core.urls_programacion`: monta el área `financiera` en la **raíz** del
...
urlpatterns = [
    ...
    # Área financiera montada en la raíz del subdominio.
    path('', include('financiera.urls')),
]
