"""Pivote y Excel de las devoluciones de colegios.
...
El detalle por material se consulta **descargando el Excel** (decisión del
usuario): en pantalla las dos áreas muestran solo el resumen por devolución.
...
def filas_export(devoluciones):
    ...
    for dev in devoluciones:
        for fila in materiales_devueltos(dev):
            filas.append([
